...
public enum Errors {
    ...
    UNKNOWN_CLIENT_METRICS_SUBSCRIPTION_ID(107, "Client metric subscription id does not match with broker's cached value", UnknownClientMetricsSubscriptionIdException::new);
